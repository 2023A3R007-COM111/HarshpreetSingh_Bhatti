//Demonstrarting the allocated bit space for int datatype.
#include<stdio.h>
#include<limits.h>
int main()
{
   // Understanding the Limits and range of dataype int 
	...
	printf("1 + Highest range of int on 32 bit throws garbage value. eg: %ld\n",(2147483647+1));
	printf("We can use Long double to fix it %d.\n\n", 2147483647);
